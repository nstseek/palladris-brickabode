...
export function BigNat$reflection() {
  return record_type('BigInt.BigNat', [], BigNat, () => [
    ['bound', int32_type],
    ['digits', array_type(int32_type)]
  ]);
}
  ...
  BigNatModule_FFT_Fp_mpow: while (true) {
    ...
    if (n === 0) {
      ...
      x_mut =
        toInt(
          op_Modulus(
            op_Multiply(fromInteger(x, true, 6), fromInteger(x, true, 6)),
            BigNatModule_FFT_Fp_p64
          )
        ) >>> 0;
      n_mut = ~~(n / 2);
      continue BigNatModule_FFT_Fp_mpow;
    } else {
      const y_2 = BigNatModule_FFT_Fp_mpow(
        toInt(
          op_Modulus(
            op_Multiply(fromInteger(x, true, 6), fromInteger(x, true, 6)),
            BigNatModule_FFT_Fp_p64
      ...
      return (
        toInt(
          op_Modulus(
            op_Multiply(fromInteger(x, true, 6), fromInteger(y_2, true, 6)),
            BigNatModule_FFT_Fp_p64
          )
        ) >>> 0
      );
...
export function BigNatModule_FFT_Fp_mpowL(x_mut, n_mut) {
  BigNatModule_FFT_Fp_mpowL: while (true) {
    ...
    if (equals(n, fromBits(0, 0, false))) {
      ...
      equals(op_Modulus(n, fromBits(2, 0, false)), fromBits(0, 0, false))
    ) {
      x_mut =
        toInt(
          op_Modulus(
      ...
      const y_2 = BigNatModule_FFT_Fp_mpowL(
        toInt(
          op_Modulus(
            op_Multiply(fromInteger(x, true, 6), fromInteger(x, true, 6)),
            BigNatModule_FFT_Fp_p64
        ...
        op_Division(n, fromBits(2, 0, false))
      );
      return (
        toInt(
          op_Modulus(
...
export function BigNatModule_FFT_Fp_m2PowNthRoot(n) {
  return BigNatModule_FFT_Fp_mpow(
    BigNatModule_FFT_w >>> 0,
    BigNatModule_FFT_pow32(2, BigNatModule_FFT_k - n)
  );
}

export function BigNatModule_FFT_Fp_minv(x) {
  return BigNatModule_FFT_Fp_mpowL(
    x,
    op_Subtraction(BigNatModule_FFT_primeP, fromBits(2, 0, false))
  );
}
...
export function BigNatModule_FFT_computeFFT(lambda, mu, n, w, u, res, offset) {
  ...
  if (n === 1) {
    ...
    const ww =
      toInt(
        op_Modulus(
          op_Multiply(fromInteger(w, true, 6), fromInteger(w, true, 6)),
          BigNatModule_FFT_Fp_p64
        )
      ) >>> 0;
    const offsetHalfN = (offset + halfN) | 0;
    BigNatModule_FFT_computeFFT(lambda * 2, mu, halfN, ww, u, res, offset);
    BigNatModule_FFT_computeFFT(
      lambda * 2,
      lambda + mu,
      halfN,
      ww,
    ...
    for (let j = 0; j <= halfN - 1; j++) {
      ...
      res[offset + j] =
        (even +
          ...
          toInt(
            op_Modulus(
              op_Multiply(fromInteger(x_1, true, 6), fromInteger(odd, true, 6)),
              BigNatModule_FFT_Fp_p64
            )
          ) >>> 0)) %
        BigNatModule_FFT_Fp_p;
      res[offsetHalfN + j] =
        (even +
          BigNatModule_FFT_Fp_p -
          ((x_3 = wj),
          toInt(
            op_Modulus(
              op_Multiply(fromInteger(x_3, true, 6), fromInteger(odd, true, 6)),
              BigNatModule_FFT_Fp_p64
            )
          ) >>> 0)) %
        BigNatModule_FFT_Fp_p;
      ...
      wj =
        toInt(
          op_Modulus(
            op_Multiply(fromInteger(w, true, 6), fromInteger(y_5, true, 6)),
            BigNatModule_FFT_Fp_p64
          )
        ) >>> 0;
    }
...
export function BigNatModule_FFT_computeInverseFftInPlace(n, w, uT) {
  ...
  return map(
    (y) =>
      toInt(
        op_Modulus(
          op_Multiply(fromInteger(bigKInv, true, 6), fromInteger(y, true, 6)),
          BigNatModule_FFT_Fp_p64
        )
      ) >>> 0,
    BigNatModule_FFT_computFftInPlace(n, BigNatModule_FFT_Fp_minv(w), uT),
    Uint32Array
  );
}
...
export const BigNatModule_FFT_twoPowerTable = initialize(
  BigNatModule_FFT_maxTwoPower - 1,
  (i) => BigNatModule_FFT_pow32(2, i),
  Int32Array
);

export function BigNatModule_FFT_computeFftPaddedPolynomialProduct(
  bigK,
  k,
  u,
  v
  ...
  return BigNatModule_FFT_computeInverseFftInPlace(
    n,
    w,
    initialize(
      n,
      (i) => {
        ...
        return (
          toInt(
            op_Modulus(
              op_Multiply(fromInteger(x, true, 6), fromInteger(y, true, 6)),
              BigNatModule_FFT_Fp_p64
            )
          ) >>> 0
        );
...
export function BigNatModule_FFT_padTo(n, u) {
  ...
  return initialize(
    ...
    (i) =>
      i < uBound
        ? BigNatModule_FFT_Fp_ofInt32(u[i])
        : BigNatModule_FFT_Fp_mzero,
    Uint32Array
  );
}
...
export function BigNatModule_FFT_computeFftPolynomialProduct(degu, u, degv, v) {
  ...
  return map(
    BigNatModule_FFT_Fp_toInt,
    BigNatModule_FFT_computeInverseFftInPlace(
      n,
      w,
      initialize(
        n,
...
export const BigNatModule_FFT_maxFp =
  (BigNatModule_FFT_Fp_p + BigNatModule_FFT_Fp_p - BigNatModule_FFT_mone) %
  BigNatModule_FFT_Fp_p;
...
export function BigNatModule_embed(x) {
  ...
  if (x_1 < BigNatModule_baseN) {
    ...
    for (let i = 0; i <= BigNatModule_boundInt - 1; i++) {
      r_1.digits[i] =
        ~~(x_1 / BigNatModule_pow32(BigNatModule_baseN, i)) %
        BigNatModule_baseN;
    }
...
export function BigNatModule_embed64(x) {
  ...
  for (let i = 0; i <= BigNatModule_boundInt64 - 1; i++) {
    r.digits[i] = ~~toInt(
      op_Modulus(
        op_Division(x_1, BigNatModule_pow64(BigNatModule_baseNi64, i)),
...
export function BigNatModule_eval64(n) {
  if (n.bound === 1) {
    ...
    for (let i = n.bound - 1; i >= 0; i--) {
      acc = op_Addition(
        fromInteger(n.digits[i], false, 2),
        op_Multiply(BigNatModule_baseNi64, acc)
      );
    }
    return acc;
  }
...
export function BigNatModule_addP(i_mut, n_mut, c_mut, p_mut, q_mut, r_mut) {
  ...
  BigNatModule_addP: while (true) {
    ...
    if (i < n) {
      const x =
        (((z = p), ((i_1 = i | 0), i_1 < z.bound ? z.digits[i_1] : 0)) +
          ((z_1 = q), ((i_2 = i | 0), i_2 < z_1.bound ? z_1.digits[i_2] : 0)) +
          c) |
        0;
...
export function BigNatModule_scale(k, p) {
  ...
  for (let i = 0; i <= p.bound - 1; i++) {
    BigNatModule_contributeArr(
      r.digits,
      i,
      op_Multiply(k_1, fromInteger(p.digits[i], false, 2))
    );
  }
  return BigNatModule_normN(r);
}
...
export function BigNatModule_mulSchoolBookBothSmall(p, q) {
  ...
  BigNatModule_setCoeff(
    r,
    0,
    ~~toInt(op_BitwiseAnd(rak, BigNatModule_baseMaski64))
  );
...
export function BigNatModule_mulSchoolBookOneSmall(p, q) {
  ...
  for (let i = 0; i <= bp - 1; i++) {
    const rak = op_Addition(
      op_Addition(c, BigNatModule_coeff64(r, i)),
      op_Multiply(BigNatModule_coeff64(p, i), q_1)
    );
    BigNatModule_setCoeff(
      r,
      i,
...
export function BigNatModule_mulSchoolBookNeitherSmall(p, q) {
  ...
  for (let i = 0; i <= p.bound - 1; i++) {
    ...
    for (let j = 0; j <= q.bound - 1; j++) {
      ...
      const rak = op_Addition(
        op_Addition(fromInteger(ra[k], false, 2), c),
        op_Multiply(pai, qaj)
      );
...
export function BigNatModule_mulSchoolBook(p, q) {
  ...
  if (pSmall ? qSmall : false) {
    return BigNatModule_mulSchoolBookBothSmall(
      BigNatModule_coeff(p, 0),
      BigNatModule_coeff(q, 0)
    );
  } else if (pSmall) {
...
export function BigNatModule_encoding$reflection() {
  return record_type(
    'BigInt.BigNatModule.encoding',
    [],
    BigNatModule_encoding,
    () => [
      ['bigL', int32_type],
      ['twoToBigL', int32_type],
      ['k', int32_type],
      ['bigK', int32_type],
      ['bigN', int32_type],
      ['split', int32_type],
      ['splits', array_type(int32_type)]
    ]
  );
}

export function BigNatModule_mkEncoding(bigL, k, bigK, bigN) {
  return new BigNatModule_encoding(
    bigL,
    BigNatModule_pow32(2, bigL),
    k,
    bigK,
    bigN,
    ~~(BigNatModule_baseBits / bigL),
    initialize(
      ~~(BigNatModule_baseBits / bigL),
      (i) => BigNatModule_pow32(2, bigL * i),
      Int32Array
    )
  );
}
...
export function BigNatModule_encodingGivenResultBits(bitsRes) {
  const selectFrom = (i_mut) => {
    selectFrom: while (true) {
      const i = i_mut;
      if (
        i + 1 < BigNatModule_table.length
          ? bitsRes < BigNatModule_table[i + 1].bigN
          : false
      ) {
        i_mut = i + 1;
        continue selectFrom;
...
export const BigNatModule_bitmask = initialize(
  BigNatModule_baseBits,
  (i) => BigNatModule_pow32(2, i) - 1,
  Int32Array
);

export const BigNatModule_twopowers = initialize(
  BigNatModule_baseBits,
  (i) => BigNatModule_pow32(2, i),
  Int32Array
);

export const BigNatModule_twopowersI64 = initialize(
  BigNatModule_baseBits,
  (i) => BigNatModule_pow64(fromBits(2, 0, false), i)
);
...
export function BigNatModule_bits(u) {
  if (u.bound === 0) {
    ...
    return (
      (BigNatModule_degree(u) * BigNatModule_baseBits +
        BigNatModule_wordBits(u.digits[BigNatModule_degree(u)])) |
      0
    );
  }
}
...
export function BigNatModule_extractBits(n, enc, bi) {
  ...
  if (biw !== bjw) {
    ...
    return (
      (((((z = n), ((i = biw | 0), i < z.bound ? z.digits[i] : 0)) >> xbit) |
        (((z_1 = n),
        ((i_1 = bjw | 0), i_1 < z_1.bound ? z_1.digits[i_1] : 0)) <<
          (BigNatModule_baseBits - xbit))) &
        BigNatModule_bitmask[enc.bigL]) |
      0
    );
  } else {
    return (
      ((((z_2 = n), ((i_2 = biw | 0), i_2 < z_2.bound ? z_2.digits[i_2] : 0)) >>
        bi % BigNatModule_baseBits) &
        BigNatModule_bitmask[enc.bigL]) |
      0
    );
  }
...
export function BigNatModule_encodePoly(enc, n) {
  const poly = fill(
    new Uint32Array(enc.bigK),
    0,
    enc.bigK,
    BigNatModule_FFT_Fp_ofInt32(0)
  );
...
export function BigNatModule_decodePoly(enc, poly) {
  const rbound =
    (~~(BigNatModule_decodeResultBits(enc, poly) / BigNatModule_baseBits) + 1) |
    0;
  const r = BigNatModule_createN(rbound);
      ...
      if (i === enc.bigK) {
        ...
        if (j >= rbound) {
          ...
          BigNatModule_contributeArr(
            ...
            j,
            op_Multiply(
              fromInteger(BigNatModule_FFT_Fp_toInt(poly[i]), false, 2),
              BigNatModule_twopowersI64[d]
            )
          );
        }
...
export function BigNatModule_quickMulUsingFft(u, v) {
  const enc = BigNatModule_encodingGivenResultBits(
    BigNatModule_bits(u) + BigNatModule_bits(v)
  );
  return BigNatModule_normN(
    BigNatModule_decodePoly(
      enc,
      BigNatModule_FFT_computeFftPaddedPolynomialProduct(
        enc.bigK,
        enc.k,
        BigNatModule_encodePoly(enc, u),
        BigNatModule_encodePoly(enc, v)
      )
    )
  );
}
...
export function BigNatModule_recMulKaratsuba(mul, p, q) {
  ...
  if (bmax > BigNatModule_minDigitsKaratsuba) {
    ...
    const q2 = mul(a1, b1);
    return BigNatModule_add(
      q0,
      BigNatModule_shiftUp(
        k,
        BigNatModule_add(
          BigNatModule_sub(q1, BigNatModule_add(q0, q2)),
          BigNatModule_shiftUp(k, q2)
        )
      )
    );
  } else {
...
export const BigNatModule_productDigitsUpperSchoolBook = ~~(
  64000 / BigNatModule_baseBits
);

export const BigNatModule_singleDigitForceSchoolBook = ~~(
  32000 / BigNatModule_baseBits
);

export const BigNatModule_productDigitsUpperFft = ~~(
        ...
        ? degx === n
          ...
          : ~~toInt(
              op_Division(
                op_Addition(
                  op_Multiply(
                    fromInteger(xa[degx], false, 2),
                    BigNatModule_baseNi64
                  ),
                  fromInteger(xa[degx - 1], false, 2)
                ),
                fromInteger(aa[0], false, 2)
              )
            )
        : degx === dega + n
        ? ~~(xa[degx] / (aa[dega] + 1))
...
export function BigNatModule_divmod(b, a) {
  if (BigNatModule_isZero(a)) {
    ...
    const d = BigNatModule_createN(
      BigNatModule_degree(b) - BigNatModule_degree(a) + 1 + 1
    );
...
export function BigNatModule_toUInt32(n) {
  ...
  switch (matchValue) {
    ...
    case 2: {
      ...
      return (
        ((patternInput[0] & BigNatModule_baseMask32A) >>> 0) +
        ((((xB & BigNatModule_baseMask32B) >>> 0) <<
          BigNatModule_baseShift32B) >>>
          0)
      );
    }
    default: {
...
export function BigNatModule_toUInt64(n) {
  ...
  switch (matchValue) {
    ...
    case 2: {
      const patternInput = [n.digits[0], n.digits[1]];
      return op_Addition(
        fromInteger(patternInput[0] & BigNatModule_baseMask64A, true, 2),
        op_LeftShift(
          fromInteger(patternInput[1] & BigNatModule_baseMask64B, true, 2),
          BigNatModule_baseShift64B
        )
      );
    }
    case 3: {
      ...
      return op_Addition(
        op_Addition(
          fromInteger(patternInput_1[0] & BigNatModule_baseMask64A, true, 2),
          op_LeftShift(
            fromInteger(patternInput_1[1] & BigNatModule_baseMask64B, true, 2),
            BigNatModule_baseShift64B
          )
        ),
        op_LeftShift(
          fromInteger(xC & BigNatModule_baseMask64C, true, 2),
          BigNatModule_baseShift64C
        )
      );
    }
    default: {
...
export function BigNatModule_toString(n) {
  ...
  const digits_4 = collect(
    true,
    new List(),
    n,
    route(new List(), 0, BigNatModule_embed(10))
  );
  ...
  const build = (acc_mut, i_mut) => {
    build: while (true) {
      ...
      if (i === len) {
        ...
        if (0 <= d ? d <= 9 : false) {
          acc_mut = BigNatModule_add(
            BigNatModule_mul(ten, acc),
            BigNatModule_embed(d)
          );
          i_mut = i + 1;
          continue build;
        } else {
...
export function BigNatModule_factorial(n) {
  const productR = (a, b) => {
    if (BigNatModule_equal(a, b)) {
      ...
      const m = BigNatModule_div(
        BigNatModule_add(a, b),
        BigNatModule_ofInt32(2)
      );
      return BigNatModule_mul(
        productR(a, m),
        productR(BigNatModule_add(m, BigNatModule_one), b)
      );
    }
  };
