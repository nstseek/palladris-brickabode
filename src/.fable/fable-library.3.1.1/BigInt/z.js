import {
  BigNatModule_factorial,
  BigNatModule_ofString,
  BigNatModule_toFloat,
  BigNatModule_toUInt64,
  BigNatModule_toUInt32,
  BigNatModule_pow,
  BigNatModule_two,
  BigNatModule_rem,
  BigNatModule_lte,
  ...
  BigNatModule_lt,
  BigNatModule_equal,
  BigNatModule_getSmall,
  BigNatModule_isSmall,
  BigNatModule_ofInt32,
  BigNatModule_toString,
  BigNatModule_isZero
} from './n.js';
...
export class BigInteger extends Record {
    ...
    switch (matchValue) {
      case -1: {
        return BigNatModule_isZero(BigInteger__get_V(x))
          ? '0'
          : '-' + BigNatModule_toString(BigInteger__get_V(x));
      }
      case 0: {
        return '0';
      }
  ...
  Equals(obj) {
    ...
    return obj instanceof BigInteger
      ? BigInteger_op_Equality_56F059C0(this$, obj)
      : false;
  }
  GetHashCode() {
    const x = this;
...
(() => {
  ...
  BigInteger.smallPosTab = initialize(
    BigInteger.smallLim,
    BigNatModule_ofInt32
  );
...
export function BigInteger_nat_Z67CCE57D(n) {
  if (
    BigNatModule_isSmall(n)
      ? BigNatModule_getSmall(n) < BigInteger.smallLim
      : false
  ) {
...
export function BigInteger_hash_Z665282C2(z) {
  if (BigInteger__get_SignInt(z) === 0) {
    ...
    return (
      (BigInteger__get_SignInt(z) + BigNatModule_hash(BigInteger__get_V(z))) | 0
    );
  }
}
...
export function BigInteger_$ctor_Z524259A4(n) {
  if (n >= 0) {
    return BigInteger_$ctor_Z2BE94A1(
      1,
      BigInteger_nat_Z67CCE57D(BigNatModule_ofInt32(n))
    );
  } else if (n === -2147483648) {
    return BigInteger_$ctor_Z2BE94A1(
      -1,
      BigInteger_nat_Z67CCE57D(
        BigNatModule_ofInt64(op_UnaryNegation(fromInteger(n, false, 2)))
      )
    );
  } else {
    return BigInteger_$ctor_Z2BE94A1(
      -1,
      BigInteger_nat_Z67CCE57D(BigNatModule_ofInt32(op_UnaryNegation_Int32(n)))
    );
  }
}
...
export function BigInteger_$ctor_Z524259C1(n) {
  if (compare(n, fromBits(0, 0, false)) >= 0) {
    return BigInteger_$ctor_Z2BE94A1(
      1,
      BigInteger_nat_Z67CCE57D(BigNatModule_ofInt64(n))
    );
    ...
    return BigInteger_$ctor_Z2BE94A1(
      ...
      BigInteger_nat_Z67CCE57D(
        BigNatModule_add(
          BigNatModule_ofInt64(fromBits(4294967295, 2147483647, false)),
          BigNatModule_one
        )
      )
    );
    ...
    return BigInteger_$ctor_Z2BE94A1(
      -1,
      BigInteger_nat_Z67CCE57D(BigNatModule_ofInt64(op_UnaryNegation(n)))
    );
  }
}
...
export function BigInteger_op_UnaryNegation_Z665282C2(z) {
  ...
  if (matchValue === 0) {
    ...
    return BigInteger_create_Z2BE94A1(
      op_UnaryNegation_Int32(matchValue),
      BigInteger__get_V(z)
    );
  }
}
...
export function BigInteger_Scale_Z320F31E(k, z) {
  if (BigInteger__get_SignInt(z) === 0) {
    ...
    return BigInteger_create_Z2BE94A1(
      op_UnaryNegation_Int32(BigInteger__get_SignInt(z)),
      BigNatModule_scale(op_UnaryNegation_Int32(k), BigInteger__get_V(z))
    );
  } else {
    return BigInteger_create_Z2BE94A1(
      BigInteger__get_SignInt(z),
      BigNatModule_scale(k, BigInteger__get_V(z))
    );
  }
}
...
export function BigInteger_op_Addition_56F059C0(x, y) {
  if (BigInteger__get_IsZero(y)) {
    ...
    switch (pattern_matching_result) {
      case 0: {
        return BigInteger_addnn_6A57060(
          BigInteger__get_V(x),
          BigInteger__get_V(y)
        );
      }
      case 1: {
        return BigInteger_op_UnaryNegation_Z665282C2(
          BigInteger_addnn_6A57060(BigInteger__get_V(x), BigInteger__get_V(y))
        );
      }
      case 2: {
        return BigInteger_subnn_6A57060(
          BigInteger__get_V(x),
          BigInteger__get_V(y)
        );
      }
...
export function BigInteger_op_Multiply_56F059C0(x, y) {
  if (BigInteger__get_IsZero(x)) {
    ...
    return BigInteger_create_Z2BE94A1(
      BigInteger__get_SignInt(x) * BigInteger__get_SignInt(y),
      m
    );
  }
}
...
export function BigInteger_DivRem_56F059C0(x, y) {
  ...
  if (BigInteger__get_IsZero(x)) {
    ...
    const patternInput = BigNatModule_divmod(
      BigInteger__get_V(x),
      BigInteger__get_V(y)
    );
...
export function BigInteger_op_RightShift_62E082A2(x, y) {
  return BigInteger_op_Division_56F059C0(
    x,
    BigInteger_Pow_62E082A2(BigInteger_get_Two(), y)
  );
}

export function BigInteger_op_LeftShift_62E082A2(x, y) {
  return BigInteger_op_Multiply_56F059C0(
    x,
    BigInteger_Pow_62E082A2(BigInteger_get_Two(), y)
  );
}
...
export function BigInteger_op_BitwiseAnd_56F059C0(x, y) {
  return BigInteger_posn_Z67CCE57D(
    BigNatModule_bitAnd(BigInteger__get_V(x), BigInteger__get_V(y))
  );
}

export function BigInteger_op_BitwiseOr_56F059C0(x, y) {
  return BigInteger_posn_Z67CCE57D(
    BigNatModule_bitOr(BigInteger__get_V(x), BigInteger__get_V(y))
  );
}

export function BigInteger_op_ExclusiveOr_56F059C0(x, y) {
  return BigInteger_posn_Z67CCE57D(
    BigNatModule_bitXor(BigInteger__get_V(x), BigInteger__get_V(y))
  );
}
...
export function BigInteger_GreatestCommonDivisor_56F059C0(x, y) {
  ...
  if (matchValue[0] === 0) {
    ...
    return BigInteger_posn_Z67CCE57D(
      BigNatModule_hcf(BigInteger__get_V(x), BigInteger__get_V(y))
    );
  }
}
...
export function BigInteger_Pow_62E082A2(x, y) {
  ...
  if (matchValue[0]) {
    ...
    return BigInteger_create_Z2BE94A1(
      BigNatModule_isZero(
        BigNatModule_rem(BigInteger__get_V(yval), BigNatModule_two)
      )
        ? 1
        : BigInteger__get_SignInt(x),
      BigNatModule_pow(BigInteger__get_V(x), BigInteger__get_V(yval))
    );
  }
}
...
export function BigInteger__get_ToInt32(x) {
  if (BigInteger__get_IsZero(x)) {
    ...
    if (u <= 2147483647 >>> 0) {
      ...
      BigInteger__get_SignInt(x) === -1 ? u === (2147483647 + 1) >>> 0 : false
    ) {
      return -2147483648;
    } else {
      throw new Error();
...
export function BigInteger__get_ToInt64(x) {
  if (BigInteger__get_IsZero(x)) {
    ...
    if (
      compare(u, fromValue(fromBits(4294967295, 2147483647, false), true)) <= 0
    ) {
      return op_Multiply(
        fromInteger(BigInteger__get_SignInt(x), false, 2),
        fromValue(u, false)
      );
    } else if (
      BigInteger__get_SignInt(x) === -1
        ? equals(
            u,
            fromValue(
              op_Addition(
                fromBits(4294967295, 2147483647, false),
                fromBits(1, 0, false)
              ),
              true
            )
...
export function BigInteger_Parse_Z721C83C5(text) {
  ...
  if (matchValue[0] === '+') {
    if (matchValue[1] === 1) {
      ...
      return BigInteger_posn_Z67CCE57D(
        BigNatModule_ofString(text_1.slice(1, len - 1 + 1))
      );
    }
    ...
    if (matchValue[1] === 1) {
      ...
      return BigInteger_negn_Z67CCE57D(
        BigNatModule_ofString(text_1.slice(1, len - 1 + 1))
      );
    }
  } else {
...
export function BigInteger_Factorial_Z665282C2(x) {
  ...
  if (BigInteger__get_IsPositive(x)) {
    return BigInteger_posn_Z67CCE57D(
      BigNatModule_factorial(BigInteger__get_V(x))
    );
  } else {
    return BigInteger_get_One();
  }
