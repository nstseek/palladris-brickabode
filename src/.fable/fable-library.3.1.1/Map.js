...
export function MapTreeNode$2$reflection(gen0, gen1) {
  return class_type(
    ...
    [gen0, gen1],
    MapTreeNode$2,
    MapTreeLeaf$2$reflection(gen0, gen1)
  );
}
...
export function MapTreeModule_rebalance(t1, k, v, t2) {
  ...
  if (t2h > t1h + 2) {
    ...
    if (matchValue instanceof MapTreeNode$2) {
      if (
        ((m_2 = MapTreeNode$2__get_Left(matchValue)),
        m_2 != null
          ? ((m2_2 = m_2),
            m2_2 instanceof MapTreeNode$2 ? MapTreeNode$2__get_Height(m2_2) : 1)
          : 0) >
        t1h + 1
      ) {
        ...
        if (matchValue_1 instanceof MapTreeNode$2) {
          return MapTreeModule_mk(
            MapTreeModule_mk(t1, k, v, MapTreeNode$2__get_Left(matchValue_1)),
            MapTreeLeaf$2__get_Key(matchValue_1),
            MapTreeLeaf$2__get_Value(matchValue_1),
            MapTreeModule_mk(
              MapTreeNode$2__get_Right(matchValue_1),
              MapTreeLeaf$2__get_Key(matchValue),
              MapTreeLeaf$2__get_Value(matchValue),
              MapTreeNode$2__get_Right(matchValue)
            )
          );
        } else {
        ...
        return MapTreeModule_mk(
          MapTreeModule_mk(t1, k, v, MapTreeNode$2__get_Left(matchValue)),
          MapTreeLeaf$2__get_Key(matchValue),
          MapTreeLeaf$2__get_Value(matchValue),
          MapTreeNode$2__get_Right(matchValue)
        );
    ...
    if (matchValue_2 instanceof MapTreeNode$2) {
      if (
        ((m_3 = MapTreeNode$2__get_Right(matchValue_2)),
        m_3 != null
          ? ((m2_3 = m_3),
            m2_3 instanceof MapTreeNode$2 ? MapTreeNode$2__get_Height(m2_3) : 1)
          : 0) >
        t2h + 1
      ) {
        ...
        if (matchValue_3 instanceof MapTreeNode$2) {
          return MapTreeModule_mk(
            MapTreeModule_mk(
              MapTreeNode$2__get_Left(matchValue_2),
              MapTreeLeaf$2__get_Key(matchValue_2),
              MapTreeLeaf$2__get_Value(matchValue_2),
              MapTreeNode$2__get_Left(matchValue_3)
            ),
            MapTreeLeaf$2__get_Key(matchValue_3),
            MapTreeLeaf$2__get_Value(matchValue_3),
            MapTreeModule_mk(MapTreeNode$2__get_Right(matchValue_3), k, v, t2)
          );
        } else {
          throw new Error('internal error: Map.rebalance');
        }
        ...
        return MapTreeModule_mk(
          ...
          MapTreeLeaf$2__get_Key(matchValue_2),
          MapTreeLeaf$2__get_Value(matchValue_2),
          MapTreeModule_mk(MapTreeNode$2__get_Right(matchValue_2), k, v, t2)
        );
      }
    } else {
      throw new Error('internal error: Map.rebalance');
    ...
    if (m2 instanceof MapTreeNode$2) {
      if (c < 0) {
        return MapTreeModule_rebalance(
          MapTreeModule_add(comparer, k, v, MapTreeNode$2__get_Left(m2)),
          MapTreeLeaf$2__get_Key(m2),
          MapTreeLeaf$2__get_Value(m2),
          MapTreeNode$2__get_Right(m2)
        );
      } else if (c === 0) {
        return MapTreeNode$2_$ctor_499A11FD(
          k,
          v,
          MapTreeNode$2__get_Left(m2),
          MapTreeNode$2__get_Right(m2),
          MapTreeNode$2__get_Height(m2)
        );
      } else {
        return MapTreeModule_rebalance(
          MapTreeNode$2__get_Left(m2),
          MapTreeLeaf$2__get_Key(m2),
          MapTreeLeaf$2__get_Value(m2),
          MapTreeModule_add(comparer, k, v, MapTreeNode$2__get_Right(m2))
        );
      }
    } else if (c < 0) {
  ...
  MapTreeModule_tryFind: while (true) {
    ...
    if (m != null) {
      ...
      if (c === 0) {
        ...
        k_mut = k;
        m_mut =
          c < 0 ? MapTreeNode$2__get_Left(m2) : MapTreeNode$2__get_Right(m2);
...
export function MapTreeModule_partitionAux(
  comparer_mut,
  f_mut,
  m_mut,
  acc_0_mut,
  ...
  MapTreeModule_partitionAux: while (true) {
    ...
    if (m != null) {
      const m2 = m;
      if (m2 instanceof MapTreeNode$2) {
        const acc_2 = MapTreeModule_partitionAux(
          comparer,
          f,
          MapTreeNode$2__get_Right(m2),
          acc[0],
        ...
        const acc_3 = MapTreeModule_partition1(
          comparer,
          f,
          MapTreeLeaf$2__get_Key(m2),
          MapTreeLeaf$2__get_Value(m2),
...
export function MapTreeModule_partition(comparer, f, m) {
  return MapTreeModule_partitionAux(
    comparer,
    f,
    m,
    MapTreeModule_empty(),
...
export function MapTreeModule_filterAux(comparer_mut, f_mut, m_mut, acc_mut) {
  MapTreeModule_filterAux: while (true) {
    ...
    if (m != null) {
      const m2 = m;
      if (m2 instanceof MapTreeNode$2) {
        const acc_1 = MapTreeModule_filterAux(
          comparer,
          f,
          MapTreeNode$2__get_Left(m2),
          acc
        );
        const acc_2 = MapTreeModule_filter1(
          comparer,
          f,
          MapTreeLeaf$2__get_Key(m2),
          MapTreeLeaf$2__get_Value(m2),
  ...
  if (m != null) {
    ...
    if (m2 instanceof MapTreeNode$2) {
      if (MapTreeNode$2__get_Left(m2) == null) {
        ...
        const patternInput = MapTreeModule_spliceOutSuccessor(
          MapTreeNode$2__get_Left(m2)
        );
        return [
          patternInput[0],
...
export function MapTreeModule_remove(comparer, k, m) {
  if (m != null) {
    ...
    if (m2 instanceof MapTreeNode$2) {
      if (c < 0) {
        return MapTreeModule_rebalance(
          MapTreeModule_remove(comparer, k, MapTreeNode$2__get_Left(m2)),
          MapTreeLeaf$2__get_Key(m2),
          MapTreeLeaf$2__get_Value(m2),
          MapTreeNode$2__get_Right(m2)
        );
        ...
        return MapTreeModule_rebalance(
          ...
          MapTreeLeaf$2__get_Key(m2),
          MapTreeLeaf$2__get_Value(m2),
          MapTreeModule_remove(comparer, k, MapTreeNode$2__get_Right(m2))
        );
      }
    } else if (c === 0) {
...
export function MapTreeModule_change(comparer, k, u, m) {
  if (m != null) {
    ...
    if (m2 instanceof MapTreeNode$2) {
      ...
      if (c < 0) {
        return MapTreeModule_rebalance(
          MapTreeModule_change(comparer, k, u, MapTreeNode$2__get_Left(m2)),
          MapTreeLeaf$2__get_Key(m2),
          MapTreeLeaf$2__get_Value(m2),
          MapTreeNode$2__get_Right(m2)
        );
        ...
        return MapTreeModule_rebalance(
          ...
          MapTreeLeaf$2__get_Key(m2),
          MapTreeLeaf$2__get_Value(m2),
          MapTreeModule_change(comparer, k, u, MapTreeNode$2__get_Right(m2))
        );
      }
    } else {
...
export function MapTreeModule_tryPickOpt(f_mut, m_mut) {
  MapTreeModule_tryPickOpt: while (true) {
    ...
    if (m != null) {
      const m2 = m;
      if (m2 instanceof MapTreeNode$2) {
        const matchValue = MapTreeModule_tryPickOpt(
          f,
          MapTreeNode$2__get_Left(m2)
        );
        if (matchValue == null) {
          const matchValue_1 = f(
            MapTreeLeaf$2__get_Key(m2),
            MapTreeLeaf$2__get_Value(m2)
          );
          if (matchValue_1 == null) {
...
export function MapTreeModule_existsOpt(f_mut, m_mut) {
  MapTreeModule_existsOpt: while (true) {
    ...
    if (m != null) {
      ...
      if (m2 instanceof MapTreeNode$2) {
        if (
          MapTreeModule_existsOpt(f, MapTreeNode$2__get_Left(m2))
            ? true
            : f(MapTreeLeaf$2__get_Key(m2), MapTreeLeaf$2__get_Value(m2))
        ) {
          return true;
...
export function MapTreeModule_forallOpt(f_mut, m_mut) {
  MapTreeModule_forallOpt: while (true) {
    ...
    if (m != null) {
      ...
      if (m2 instanceof MapTreeNode$2) {
        if (
          MapTreeModule_forallOpt(f, MapTreeNode$2__get_Left(m2))
            ? f(MapTreeLeaf$2__get_Key(m2), MapTreeLeaf$2__get_Value(m2))
            : false
        ) {
          f_mut = f;
...
export function MapTreeModule_map(f, m) {
  if (m != null) {
    ...
    if (m2 instanceof MapTreeNode$2) {
      ...
      return MapTreeLeaf$2_$ctor_5BDDA1(
        MapTreeLeaf$2__get_Key(m2),
        f(MapTreeLeaf$2__get_Value(m2))
      );
    }
  } else {
    return MapTreeModule_empty();
...
export function MapTreeModule_foldBackOpt(f_mut, m_mut, x_mut) {
  MapTreeModule_foldBackOpt: while (true) {
    ...
    if (m != null) {
      const m2 = m;
      if (m2 instanceof MapTreeNode$2) {
        const x_1 = MapTreeModule_foldBackOpt(
          f,
          MapTreeNode$2__get_Right(m2),
          x
        );
  ...
  MapTreeModule_foldOpt: while (true) {
    ...
    if (m != null) {
      ...
      if (m2 instanceof MapTreeNode$2) {
        f_mut = f;
        x_mut = f(
          MapTreeModule_foldOpt(f, x, MapTreeNode$2__get_Left(m2)),
          MapTreeLeaf$2__get_Key(m2),
          MapTreeLeaf$2__get_Value(m2)
        );
        m_mut = MapTreeNode$2__get_Right(m2);
    ...
    foldFromTo: while (true) {
      ...
      if (m_1 != null) {
        ...
        if (m2 instanceof MapTreeNode$2) {
          ...
          const x_2 =
            cLoKey < 0
              ? foldFromTo(f_1, MapTreeNode$2__get_Left(m2), x_1)
              : x_1;
          const x_3 = (cLoKey <= 0 ? cKeyHi <= 0 : false)
            ? f_1(MapTreeLeaf$2__get_Key(m2), MapTreeLeaf$2__get_Value(m2), x_2)
            : x_2;
          if (cKeyHi < 0) {
            f_1_mut = f_1;
          ...
          comparer.Compare(lo, MapTreeLeaf$2__get_Key(m2)) <= 0
            ? comparer.Compare(MapTreeLeaf$2__get_Key(m2), hi) <= 0
            : false
        ) {
          return f_1(
            MapTreeLeaf$2__get_Key(m2),
    ...
    loop: while (true) {
      ...
      if (m_1 != null) {
        ...
        if (m2 instanceof MapTreeNode$2) {
          ...
          acc_mut = new List(
            [MapTreeLeaf$2__get_Key(m2), MapTreeLeaf$2__get_Value(m2)],
...
export function MapTreeModule_ofList(comparer, l) {
  return fold_1(
    (acc, tupledArg) =>
      MapTreeModule_add(comparer, tupledArg[0], tupledArg[1], acc),
    MapTreeModule_empty(),
    l
  );
}
...
export function MapTreeModule_ofSeq(comparer, c) {
  if (isArrayLike(c)) {
    ...
    try {
      return MapTreeModule_mkFromEnumerator(
        comparer,
        MapTreeModule_empty(),
        ie
      );
...
export function MapTreeModule_MapIterator$2$reflection(gen0, gen1) {
  return record_type(
    ...
    () => [
      ['stack', list_type(option_type(MapTreeLeaf$2$reflection(gen0, gen1)))],
      ['started', bool_type]
    ]
  );
}
      ...
      if (m != null) {
        ...
        if (m2 instanceof MapTreeNode$2) {
          stack_mut = new List(
            MapTreeNode$2__get_Left(m2),
            new List(
              MapTreeLeaf$2_$ctor_5BDDA1(
                MapTreeLeaf$2__get_Key(m2),
                MapTreeLeaf$2__get_Value(m2)
              ),
              new List(MapTreeNode$2__get_Right(m2), rest)
            )
          );
...
export function MapTreeModule_mkIterator(m) {
  return new MapTreeModule_MapIterator$2(
    MapTreeModule_collapseLHS(new List(m, new List())),
    false
  );
}
...
export class FSharpMap {
  ...
  toString() {
    ...
    return (
      ...
      join(
        '; ',
        map_2((kv) => format('({0}, {1})', kv[0], kv[1]), this$)
      ) +
      ']'
    );
  }
  ...
  ['System.Collections.Generic.ICollection`1.Contains2B595'](x) {
    const m = this;
    return FSharpMap__ContainsKey(m, x[0])
      ? equals(FSharpMap__get_Item(m, x[0]), x[1])
      : false;
  }
...
(() => {
  FSharpMap.empty = FSharpMap_$ctor(
...
export function FSharpMap__Add(m, key, value) {
  return FSharpMap_$ctor(
    m.comparer,
    MapTreeModule_add(m.comparer, key, value, m.tree)
  );
}
...
export function FSharpMap__Change(m, key, f) {
  return FSharpMap_$ctor(
    m.comparer,
    MapTreeModule_change(m.comparer, key, f, m.tree)
  );
}
...
export function FSharpMap__Filter(m, predicate) {
  return FSharpMap_$ctor(
    m.comparer,
    MapTreeModule_filter(m.comparer, predicate, m.tree)
  );
}
...
export function FSharpMap__Remove(m, key) {
  return FSharpMap_$ctor(
    m.comparer,
    MapTreeModule_remove(m.comparer, key, m.tree)
  );
}
...
export function FSharpMap__ComputeHashCode(this$) {
  ...
  try {
    while (enumerator['System.Collections.IEnumerator.MoveNext']()) {
      const activePatternResult4281 = enumerator[
        'System.Collections.Generic.IEnumerator`1.get_Current'
      ]();
