...
export function SetTreeModule_rebalance(t1, v, t2) {
  ...
  if (t2h > t1h + 2) {
    ...
    if (matchValue instanceof SetTreeNode$1) {
      if (
        ((t_2 = SetTreeNode$1__get_Left(matchValue)),
        t_2 != null
          ? ((t2_3 = t_2),
            t2_3 instanceof SetTreeNode$1 ? SetTreeNode$1__get_Height(t2_3) : 1)
          : 0) >
        t1h + 1
      ) {
        ...
        if (matchValue_1 instanceof SetTreeNode$1) {
          return SetTreeModule_mk(
            SetTreeModule_mk(t1, v, SetTreeNode$1__get_Left(matchValue_1)),
            SetTreeLeaf$1__get_Key(matchValue_1),
            SetTreeModule_mk(
              SetTreeNode$1__get_Right(matchValue_1),
              SetTreeLeaf$1__get_Key(matchValue),
              SetTreeNode$1__get_Right(matchValue)
            )
          );
        } else {
        ...
        return SetTreeModule_mk(
          SetTreeModule_mk(t1, v, SetTreeNode$1__get_Left(matchValue)),
          SetTreeLeaf$1__get_Key(matchValue),
          SetTreeNode$1__get_Right(matchValue)
        );
      }
    ...
    if (matchValue_2 instanceof SetTreeNode$1) {
      if (
        ((t_3 = SetTreeNode$1__get_Right(matchValue_2)),
        t_3 != null
          ? ((t2_4 = t_3),
            t2_4 instanceof SetTreeNode$1 ? SetTreeNode$1__get_Height(t2_4) : 1)
          : 0) >
        t2h + 1
      ) {
        ...
        if (matchValue_3 instanceof SetTreeNode$1) {
          return SetTreeModule_mk(
            SetTreeModule_mk(
              SetTreeNode$1__get_Left(matchValue_2),
              SetTreeLeaf$1__get_Key(matchValue_2),
              SetTreeNode$1__get_Left(matchValue_3)
            ),
            SetTreeLeaf$1__get_Key(matchValue_3),
            SetTreeModule_mk(SetTreeNode$1__get_Right(matchValue_3), v, t2)
          );
        } else {
          throw new Error('internal error: Set.rebalance');
        }
        ...
        return SetTreeModule_mk(
          SetTreeNode$1__get_Left(matchValue_2),
          SetTreeLeaf$1__get_Key(matchValue_2),
          SetTreeModule_mk(SetTreeNode$1__get_Right(matchValue_2), v, t2)
        );
      }
    } else {
      throw new Error('internal error: Set.rebalance');
    ...
    if (t2 instanceof SetTreeNode$1) {
      if (c < 0) {
        return SetTreeModule_rebalance(
          SetTreeModule_add(comparer, k, SetTreeNode$1__get_Left(t2)),
        ...
        return SetTreeModule_rebalance(
          ...
          SetTreeLeaf$1__get_Key(t2),
          SetTreeModule_add(comparer, k, SetTreeNode$1__get_Right(t2))
        );
      }
    } else {
    ...
    if (t2 != null) {
      ...
      if (t1$0027 instanceof SetTreeNode$1) {
        if (t2$0027 instanceof SetTreeNode$1) {
          if (
            SetTreeNode$1__get_Height(t1$0027) + 2 <
            SetTreeNode$1__get_Height(t2$0027)
          ) {
            return SetTreeModule_rebalance(
              SetTreeModule_balance(
                ...
                t1,
                k,
                SetTreeNode$1__get_Left(t2$0027)
              ),
              SetTreeLeaf$1__get_Key(t2$0027),
              SetTreeNode$1__get_Right(t2$0027)
            );
          } else if (
            SetTreeNode$1__get_Height(t2$0027) + 2 <
            SetTreeNode$1__get_Height(t1$0027)
          ) {
            return SetTreeModule_rebalance(
              SetTreeNode$1__get_Left(t1$0027),
              SetTreeLeaf$1__get_Key(t1$0027),
              SetTreeModule_balance(
                comparer,
                SetTreeNode$1__get_Right(t1$0027),
                k,
                t2
              )
            );
          ...
          return SetTreeModule_add(
            comparer,
            k,
            SetTreeModule_add(comparer, SetTreeLeaf$1__get_Key(t2$0027), t1)
          );
        }
      } else {
        return SetTreeModule_add(
          comparer,
          k,
          SetTreeModule_add(comparer, SetTreeLeaf$1__get_Key(t1$0027), t2)
        );
      }
    } else {
...
export function SetTreeModule_split(comparer, pivot, t) {
  if (t != null) {
    ...
    if (t2 instanceof SetTreeNode$1) {
      ...
      if (c < 0) {
        const patternInput = SetTreeModule_split(
          comparer,
          pivot,
          SetTreeNode$1__get_Left(t2)
        );
        ...
        const patternInput_1 = SetTreeModule_split(
          comparer,
          pivot,
          SetTreeNode$1__get_Right(t2)
        );
  ...
  if (t != null) {
    ...
    if (t2 instanceof SetTreeNode$1) {
      if (SetTreeNode$1__get_Left(t2) == null) {
        ...
        const patternInput = SetTreeModule_spliceOutSuccessor(
          SetTreeNode$1__get_Left(t2)
        );
        return [
          patternInput[0],
...
export function SetTreeModule_remove(comparer, k, t) {
  if (t != null) {
    ...
    if (t2 instanceof SetTreeNode$1) {
      if (c < 0) {
        return SetTreeModule_rebalance(
          SetTreeModule_remove(comparer, k, SetTreeNode$1__get_Left(t2)),
          SetTreeLeaf$1__get_Key(t2),
          SetTreeNode$1__get_Right(t2)
        );
      } else if (c === 0) {
        ...
        return SetTreeModule_rebalance(
          SetTreeNode$1__get_Left(t2),
          SetTreeLeaf$1__get_Key(t2),
          SetTreeModule_remove(comparer, k, SetTreeNode$1__get_Right(t2))
        );
      }
    } else if (c === 0) {
  ...
  SetTreeModule_foldBackOpt: while (true) {
    ...
    if (t != null) {
      ...
      if (t2 instanceof SetTreeNode$1) {
        ...
        x_mut = f(
          SetTreeLeaf$1__get_Key(t2),
          SetTreeModule_foldBackOpt(f, SetTreeNode$1__get_Right(t2), x)
        );
  ...
  SetTreeModule_foldOpt: while (true) {
    ...
    if (t != null) {
      ...
      if (t2 instanceof SetTreeNode$1) {
        f_mut = f;
        x_mut = f(
          SetTreeModule_foldOpt(f, x, SetTreeNode$1__get_Left(t2)),
          SetTreeLeaf$1__get_Key(t2)
        );
        t_mut = SetTreeNode$1__get_Right(t2);
  ...
  SetTreeModule_forall: while (true) {
    ...
    if (t != null) {
      ...
      if (t2 instanceof SetTreeNode$1) {
        if (
          f(SetTreeLeaf$1__get_Key(t2))
            ? SetTreeModule_forall(f, SetTreeNode$1__get_Left(t2))
            : false
        ) {
          f_mut = f;
          t_mut = SetTreeNode$1__get_Right(t2);
    ...
    if (t != null) {
      ...
      if (t2 instanceof SetTreeNode$1) {
        if (
          f(SetTreeLeaf$1__get_Key(t2))
            ? true
            : SetTreeModule_exists(f, SetTreeNode$1__get_Left(t2))
        ) {
          return true;
        } else {
          f_mut = f;
...
export function SetTreeModule_properSubset(comparer, a, b) {
  if (SetTreeModule_forall((x) => SetTreeModule_mem(comparer, x, b), a)) {
    return SetTreeModule_exists(
      (x_1) => !SetTreeModule_mem(comparer, x_1, a),
      b
    );
  } else {
    return false;
...
export function SetTreeModule_filterAux(comparer_mut, f_mut, t_mut, acc_mut) {
  SetTreeModule_filterAux: while (true) {
    ...
    if (t != null) {
      const t2 = t;
      if (t2 instanceof SetTreeNode$1) {
        const acc_1 = f(SetTreeLeaf$1__get_Key(t2))
          ? SetTreeModule_add(comparer, SetTreeLeaf$1__get_Key(t2), acc)
          : acc;
        comparer_mut = comparer;
        f_mut = f;
        t_mut = SetTreeNode$1__get_Left(t2);
        acc_mut = SetTreeModule_filterAux(
          comparer,
          f,
          SetTreeNode$1__get_Right(t2),
          acc_1
    ...
    if (acc == null) {
      ...
      if (t2 instanceof SetTreeNode$1) {
        ...
        acc_mut = SetTreeModule_diffAux(
          comparer,
          SetTreeNode$1__get_Right(t2),
          SetTreeModule_remove(comparer, SetTreeLeaf$1__get_Key(t2), acc)
        );
...
export function SetTreeModule_intersectionAux(
  comparer_mut,
  b_mut,
  t_mut,
  acc_mut
  ...
  SetTreeModule_intersectionAux: while (true) {
    ...
    if (t != null) {
      const t2 = t;
      if (t2 instanceof SetTreeNode$1) {
        const acc_1 = SetTreeModule_intersectionAux(
          comparer,
          b,
          SetTreeNode$1__get_Right(t2),
          acc
        );
        const acc_2 = SetTreeModule_mem(comparer, SetTreeLeaf$1__get_Key(t2), b)
          ? SetTreeModule_add(comparer, SetTreeLeaf$1__get_Key(t2), acc_1)
          : acc_1;
        comparer_mut = comparer;
        b_mut = b;
        t_mut = SetTreeNode$1__get_Left(t2);
...
export function SetTreeModule_partitionAux(
  comparer_mut,
  f_mut,
  t_mut,
  acc_0_mut,
  ...
  SetTreeModule_partitionAux: while (true) {
    ...
    if (t != null) {
      const t2 = t;
      if (t2 instanceof SetTreeNode$1) {
        const acc_2 = SetTreeModule_partitionAux(
          comparer,
          f,
          SetTreeNode$1__get_Right(t2),
          acc[0],
        ...
        const acc_3 = SetTreeModule_partition1(
          comparer,
          f,
          SetTreeLeaf$1__get_Key(t2),
          acc_2[0],
...
export function SetTreeModule_partition(comparer, f, s) {
  return SetTreeModule_partitionAux(
    comparer,
    f,
    s,
    SetTreeModule_empty(),
...
export function SetTreeModule_SetIterator$1$reflection(gen0) {
  return record_type(
    ...
    () => [
      ['stack', list_type(option_type(SetTreeLeaf$1$reflection(gen0)))],
      ['started', bool_type]
    ]
  );
}
        ...
        if (x2 instanceof SetTreeNode$1) {
          stack_mut = new List(
            ...
            new List(
              ...
              new List(SetTreeNode$1__get_Right(x2), rest)
            )
          );
...
export function SetTreeModule_mkIterator(s) {
  return new SetTreeModule_SetIterator$1(
    SetTreeModule_collapseLHS(new List(s, new List())),
    false
  );
}
              ...
              if (SetTreeNode$1__get_Left(x1_3) == null) {
                if (x2_3 instanceof SetTreeNode$1) {
                  if (SetTreeNode$1__get_Left(x2_3) == null) {
                    const c =
                      comparer.Compare(
                        SetTreeLeaf$1__get_Key(x1_3),
                        SetTreeLeaf$1__get_Key(x2_3)
                      ) | 0;
                    if (c !== 0) {
                      return c | 0;
                    } else {
                      comparer_mut = comparer;
                      l1_mut = new List(
                        SetTreeNode$1__get_Right(x1_3),
                        matchValue[0].tail
                      );
                      l2_mut = new List(
                        SetTreeNode$1__get_Right(x2_3),
                        matchValue[1].tail
                      );
                      ...
                      case 0: {
                        if (x1_4 instanceof SetTreeNode$1) {
                          ...
                          l1_mut = new List(
                            ...
                            new List(
                              SetTreeNode$1_$ctor_Z6E7BE5F7(
                                SetTreeLeaf$1__get_Key(x1_4),
                                SetTreeModule_empty(),
                                SetTreeNode$1__get_Right(x1_4),
                                0
                              ),
                              t1_6
                            )
                      ...
                      case 1: {
                        if (x2_4 instanceof SetTreeNode$1) {
                          ...
                          l2_mut = new List(
                            ...
                            new List(
                              SetTreeNode$1_$ctor_Z6E7BE5F7(
                                SetTreeLeaf$1__get_Key(x2_4),
                                SetTreeModule_empty(),
                                SetTreeNode$1__get_Right(x2_4),
                                0
                              ),
                              t2_6
                            )
                  ...
                  case 0: {
                    if (x1_5 instanceof SetTreeNode$1) {
                      ...
                      l1_mut = new List(
                        ...
                        new List(
                          SetTreeNode$1_$ctor_Z6E7BE5F7(
                            SetTreeLeaf$1__get_Key(x1_5),
                            SetTreeModule_empty(),
                            SetTreeNode$1__get_Right(x1_5),
                            0
                          ),
                          t1_7
                        )
                  ...
                  case 1: {
                    if (x2_5 instanceof SetTreeNode$1) {
                      ...
                      l2_mut = new List(
                        ...
                        new List(
                          SetTreeNode$1_$ctor_Z6E7BE5F7(
                            SetTreeLeaf$1__get_Key(x2_5),
                            SetTreeModule_empty(),
                            SetTreeNode$1__get_Right(x2_5),
                            0
                          ),
                          t2_7
                        )
                  ...
                  case 0: {
                    if (x1_6 instanceof SetTreeNode$1) {
                      ...
                      l1_mut = new List(
                        ...
                        new List(
                          SetTreeNode$1_$ctor_Z6E7BE5F7(
                            SetTreeLeaf$1__get_Key(x1_6),
                            SetTreeModule_empty(),
                            SetTreeNode$1__get_Right(x1_6),
                            0
                          ),
                          t1_8
                        )
                  ...
                  case 1: {
                    if (x2_6 instanceof SetTreeNode$1) {
                      ...
                      l2_mut = new List(
                        ...
                        new List(
                          SetTreeNode$1_$ctor_Z6E7BE5F7(
                            SetTreeLeaf$1__get_Key(x2_6),
                            SetTreeModule_empty(),
                            SetTreeNode$1__get_Right(x2_6),
                            0
                          ),
                          t2_8
                        )
              ...
              case 0: {
                if (x1 instanceof SetTreeNode$1) {
                  ...
                  l1_mut = new List(
                    ...
                    new List(
                      SetTreeNode$1_$ctor_Z6E7BE5F7(
                        SetTreeLeaf$1__get_Key(x1),
                        SetTreeModule_empty(),
                        SetTreeNode$1__get_Right(x1),
                        0
                      ),
                      t1_2
                    )
              ...
              case 1: {
                if (x2_1 instanceof SetTreeNode$1) {
                  ...
                  l2_mut = new List(
                    ...
                    new List(
                      SetTreeNode$1_$ctor_Z6E7BE5F7(
                        SetTreeLeaf$1__get_Key(x2_1),
                        SetTreeModule_empty(),
                        SetTreeNode$1__get_Right(x2_1),
                        0
                      ),
                      t2_2
                    )
            ...
            case 0: {
              if (x1_2 instanceof SetTreeNode$1) {
                ...
                l1_mut = new List(
                  ...
                  new List(
                    SetTreeNode$1_$ctor_Z6E7BE5F7(
                      SetTreeLeaf$1__get_Key(x1_2),
                      SetTreeModule_empty(),
                      SetTreeNode$1__get_Right(x1_2),
                      0
                    ),
                    t1_4
                  )
            ...
            case 1: {
              if (x2_2 instanceof SetTreeNode$1) {
                ...
                l2_mut = new List(
                  ...
                  new List(
                    SetTreeNode$1_$ctor_Z6E7BE5F7(
                      SetTreeLeaf$1__get_Key(x2_2),
                      SetTreeModule_empty(),
                      SetTreeNode$1__get_Right(x2_2),
                      0
                    ),
                    t2_4
                  )
  ...
  if (t1 == null) {
    ...
    return (
      SetTreeModule_compareStacks(
        comparer,
        new List(t1, new List()),
        new List(t2, new List())
      ) | 0
    );
  }
}
    ...
    loop: while (true) {
      ...
      if (t$0027 != null) {
        ...
        if (t2 instanceof SetTreeNode$1) {
          ...
          acc_mut = new List(
            SetTreeLeaf$1__get_Key(t2),
            loop(SetTreeNode$1__get_Right(t2), acc)
          );
          continue loop;
        } else {
...
export function SetTreeModule_ofArray(comparer, l) {
  return fold_1(
    (acc, k) => SetTreeModule_add(comparer, k, acc),
    SetTreeModule_empty(),
    l
  );
}
...
export class FSharpSet {
  ...
  Equals(that) {
    const this$ = this;
    return that instanceof FSharpSet
      ? SetTreeModule_compare(
          FSharpSet__get_Comparer(this$),
          FSharpSet__get_Tree(this$),
          FSharpSet__get_Tree(that)
        ) === 0
      : false;
  }
  toString() {
  ...
  CompareTo(that) {
    ...
    return (
      SetTreeModule_compare(
        FSharpSet__get_Comparer(s),
        FSharpSet__get_Tree(s),
        FSharpSet__get_Tree(that)
      ) | 0
    );
  }
...
export function FSharpSet__Add(s, value) {
  return FSharpSet_$ctor(
    FSharpSet__get_Comparer(s),
    SetTreeModule_add(FSharpSet__get_Comparer(s), value, FSharpSet__get_Tree(s))
  );
}
...
export function FSharpSet__Partition(s, f) {
  if (FSharpSet__get_Tree(s) == null) {
    ...
    const patternInput = SetTreeModule_partition(
      FSharpSet__get_Comparer(s),
      f,
      FSharpSet__get_Tree(s)
    );
...
export function FSharpSet__Map(s, f, comparer) {
  return FSharpSet_$ctor(
    comparer,
    SetTreeModule_fold(
      (acc, k) => SetTreeModule_add(comparer, f(k), acc),
      SetTreeModule_empty(),
      FSharpSet__get_Tree(s)
    )
  );
...
export function FSharpSet_op_Subtraction(set1, set2) {
  if (FSharpSet__get_Tree(set1) == null) {
    ...
    return FSharpSet_$ctor(
      ...
      SetTreeModule_diff(
        FSharpSet__get_Comparer(set1),
        FSharpSet__get_Tree(set1),
        FSharpSet__get_Tree(set2)
      )
    );
  }
}
  ...
  if (FSharpSet__get_Tree(b) == null) {
    ...
    return FSharpSet_$ctor(
      ...
      SetTreeModule_intersection(
        FSharpSet__get_Comparer(a),
        FSharpSet__get_Tree(a),
        FSharpSet__get_Tree(b)
      )
    );
  }
}
...
export function FSharpSet__IsSubsetOf(x, otherSet) {
  return SetTreeModule_subset(
    FSharpSet__get_Comparer(x),
    FSharpSet__get_Tree(x),
    FSharpSet__get_Tree(otherSet)
  );
}
...
export function distinct(xs, comparer) {
  return delay(() => {
    ...
    return collect(
      (x) => (HashSet__Add_2B595(set$, x) ? singleton_1(x) : empty_1()),
      xs
    );
  });
}
...
export function distinctBy(projection, xs, comparer) {
  return delay(() => {
    ...
    return collect(
      (x) =>
        HashSet__Add_2B595(set$, projection(x)) ? singleton_1(x) : empty_1(),
      xs
    );
  });
}
