import {
  BigInteger_op_Inequality_56F059C0,
  BigInteger_op_Equality_56F059C0,
  BigInteger_op_GreaterThanOrEqual_56F059C0,
  BigInteger_op_GreaterThan_56F059C0,
  BigInteger_op_LessThanOrEqual_56F059C0,
  BigInteger_op_LessThan_56F059C0,
  BigInteger_op_ExclusiveOr_56F059C0,
  BigInteger_op_BitwiseOr_56F059C0,
  BigInteger_op_BitwiseAnd_56F059C0,
  BigInteger_op_LeftShift_62E082A2,
  BigInteger_op_RightShift_62E082A2,
  BigInteger_op_UnaryPlus_Z665282C2,
  BigInteger_op_UnaryNegation_Z665282C2,
  BigInteger_op_Modulus_56F059C0,
  BigInteger_op_Division_56F059C0,
  BigInteger_op_Multiply_56F059C0,
  BigInteger_op_Subtraction_56F059C0,
  BigInteger_op_Addition_56F059C0,
  BigInteger__get_IsOne,
  BigInteger__get_IsZero,
  BigInteger__get_Sign,
  BigInteger__get_ToDecimal,
  BigInteger__get_ToDouble,
  BigInteger__get_ToSingle,
  BigInteger__get_ToUInt64,
  BigInteger__get_ToInt64,
  BigInteger__get_ToUInt32,
  BigInteger__get_ToInt32,
  BigInteger__get_ToUInt16,
  BigInteger__get_ToInt16,
  BigInteger__get_ToByte,
  BigInteger__get_ToSByte,
  BigInteger_$ctor_Z524259A4,
  BigInteger_$ctor_Z524259C1,
  BigInteger_get_Two,
  BigInteger_get_One,
  BigInteger_get_Zero,
  BigInteger_Abs_Z665282C2,
  BigInteger_Pow_62E082A2,
  BigInteger_GreatestCommonDivisor_56F059C0,
  BigInteger_DivRem_56F059C0,
  BigInteger_Parse_Z721C83C5,
  BigInteger
} from './BigInt/z.js';
...
export function toByteArray(value) {
  if (equals_1(value, zero)) {
    ...
    const value_1 = isPositive
      ? value
      : BigInteger_op_Multiply_56F059C0(BigInteger_$ctor_Z524259A4(-1), value);
    ...
    const loop = (accumBytes_mut, consumeValue_mut, lowBitFound_mut) => {
      ...
      loop: while (true) {
        ...
        if (compare_1(consumeValue, zero) <= 0) {
          const accumBytes_1 = isPositive
            ? skipWhile((b) => b === 0, accumBytes)
            : skipWhile((b_1) => b_1 === 255, accumBytes);
          const isHighBitOne = (head(accumBytes_1) & 128) !== 0;
          return reverse(
            Uint8Array.from(
              (isPositive ? isHighBitOne : false)
                ? new List(0, accumBytes_1)
                : (!isPositive ? !isHighBitOne : false)
                ? new List(255, accumBytes_1)
                : accumBytes_1
            )
          );
        } else {
          const currValue = toUInt32(
            BigInteger_op_BitwiseAnd_56F059C0(consumeValue, mask32)
          );
          if (isPositive) {
            ...
            b2 = value_5 & 0xff;
            accumBytes_mut = new List(
              ((value_6 = currValue >>> 24), value_6 & 0xff),
              new List(b2, new List(b1, new List(b0, accumBytes)))
            );
            consumeValue_mut = BigInteger_op_RightShift_62E082A2(
              consumeValue,
              32
            );
            ...
            const patternInput = flipTwosComplement(
              currValue & 0xff,
              lowBitFound
            );
            const patternInput_1 = flipTwosComplement(
              ((value_8 = currValue >>> 8), value_8 & 0xff),
              patternInput[1]
            );
            const patternInput_2 = flipTwosComplement(
              ((value_9 = currValue >>> 16), value_9 & 0xff),
              patternInput_1[1]
            );
            const patternInput_3 = flipTwosComplement(
              ((value_10 = currValue >>> 24), value_10 & 0xff),
              patternInput_2[1]
            );
            accumBytes_mut = new List(
              patternInput_3[0],
              new List(
                ...
                new List(
                  patternInput_1[0],
                  new List(patternInput[0], accumBytes)
                )
              )
            );
            consumeValue_mut = BigInteger_op_RightShift_62E082A2(
      ...
      loop: while (true) {
        ...
        if (bytesRemaining === 0) {
          const value_2 = fold(
            (acc, value) =>
              BigInteger_op_Addition_56F059C0(
                BigInteger_op_LeftShift_62E082A2(acc, 32),
                fromInt64(fromInteger(value, false, 6))
              ),
            zero,
            accumUInt32
          );
          ...
          if (isPositive) {
            ...
            accumUInt32_mut = new List(
              (((((buffer[0] | ((buffer[1] << 8) >>> 0)) >>> 0) |
                ((buffer[2] << 16) >>> 0)) >>>
                0) |
                ((buffer[3] << 24) >>> 0)) >>>
                0,
            ...
            accumUInt32_mut = new List(
              (((((patternInput[0] | ((patternInput_1[0] << 8) >>> 0)) >>> 0) |
                ((patternInput_2[0] << 16) >>> 0)) >>>
                0) |
                ((patternInput_3[0] << 24) >>> 0)) >>>
                0,
              accumUInt32
            );
            currIndex_mut = currIndex + bytesToProcess;
...
export function makeRangeStepFunction(step, last) {
  ...
  return (x) => {
    ...
    return (
      (stepGreaterThanZero ? comparedWithLast <= 0 : false)
        ? true
        : !stepGreaterThanZero
        ? comparedWithLast >= 0
        : false
    )
      ? [x, BigInteger_op_Addition_56F059C0(x, step)]
      : void 0;
  };
}
