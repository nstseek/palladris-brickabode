...
export function timeOfDay(d) {
  var _a;
  const d2 = new Date(
    d.getTime() + ((_a = d.offset) !== null && _a !== void 0 ? _a : 0)
  );
  return (
    d2.getUTCHours() * 3600000 +
...
export function add(d, ts) {
  ...
  return DateTimeOffset(
    d.getTime() + ts,
    (_a = d.offset) !== null && _a !== void 0 ? _a : 0
  );
}
export function addDays(d, v) {
  var _a;
  return DateTimeOffset(
    d.getTime() + v * 86400000,
    (_a = d.offset) !== null && _a !== void 0 ? _a : 0
  );
}
...
export function addMonths(d, v) {
  ...
  return create(
    ...
    d2.getUTCSeconds(),
    d2.getUTCMilliseconds(),
    (_b = d.offset) !== null && _b !== void 0 ? _b : 0
  );
}
