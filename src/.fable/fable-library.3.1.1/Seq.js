...
export function toIterator(en) {
  return {
    ...
    next() {
      ...
      const current = hasNext
        ? en['System.Collections.IEnumerator.get_Current']()
        : undefined;
...
export function ofArray(xs) {
  if (Array.isArray(xs)) {
    ...
    return delay(() =>
      unfold(
        (i) => (i != null && i < xs.length ? [xs[i], i + 1] : undefined),
        0
      )
    );
  }
...
export function enumerateFromFunctions(factory, moveNext, current) {
  return delay(() =>
    unfold((e) => (moveNext(e) ? [current(e), e] : undefined), factory())
  );
}
...
export function except(itemsToExclude, source) {
  ...
  const testIsNotInExclusionItems = (element) =>
...
export function iterateIndexed(f, xs) {
  fold(
    (_, x, i) => (f(i !== null && i !== void 0 ? i : 0, x), undefined),
    undefined,
    xs
  );
}
export function iterateIndexed2(f, xs, ys) {
  fold2(
    (_, x, y, i) => (f(i !== null && i !== void 0 ? i : 0, x, y), undefined),
    undefined,
    xs,
    ys
  );
...
export function map2(f, xs, ys) {
  return delay(() => {
    ...
    return unfold(() => {
      ...
      return !cur1.done && !cur2.done
        ? [f(cur1.value, cur2.value), undefined]
        : undefined;
    }, undefined);
  });
}
export function mapIndexed2(f, xs, ys) {
  return delay(() => {
    ...
    return unfold(() => {
      ...
      const cur2 = iter2.next();
      return !cur1.done && !cur2.done
        ? [f(i++, cur1.value, cur2.value), undefined]
        : undefined;
    }, undefined);
  });
}
  ...
  return delay(() => {
    ...
    return unfold(() => {
      ...
      return !cur1.done && !cur2.done && !cur3.done
        ? [f(cur1.value, cur2.value, cur3.value), undefined]
        : undefined;
    }, undefined);
  });
}
